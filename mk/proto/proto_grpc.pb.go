...
const (
	LiveChat_ChatStream_FullMethodName = "/proto.LiveChat/ChatStream"
)
...
func (c *liveChatClient) ChatStream(ctx context.Context, opts ...grpc.CallOption) (LiveChat_ChatStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &LiveChat_ServiceDesc.Streams[0], LiveChat_ChatStream_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
